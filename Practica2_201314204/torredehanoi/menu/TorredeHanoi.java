...
public class TorredeHanoi extends JFrame {
	...
	public TorredeHanoi(){
	    ...
	    + "\n\n1) Las piezas se mueven de una en una, empezando por la más pequeña."
	    ...
	    final JTextArea participante = new JTextArea("");
	    participante.setBounds(500, 100, 200, 30);
		...
		bNuevo.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
            	...
            	guardarNombre(usuario.getText()); {
                	...
                	else if (usuario.getText()!= ("")){
                	
                	participante.setVisible(true);
                	participante.setText(usuario.getText());
