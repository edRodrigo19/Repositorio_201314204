...
//        algoritmoHanoi(6);
    ...
    public static void algoritmoHanoi(int n, int inicio, int temporal, int destino) {
        if (n == 0) {
            return;
        }
        algoritmoHanoi(n - 1, inicio, destino, temporal);
        System.out.println("Mover " + n + " de la torre " + inicio + " a la torre " + destino + ".");
        algoritmoHanoi(n - 1, temporal, inicio, destino);
    }
