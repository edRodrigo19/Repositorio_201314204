...
public class Graficos extends JPanel implements ActionListener {
    ...
    private static final int LIMITE_FICHAS = 5;
    private static final int LIMITE_TORRES = 3;
    private Hanoi nucleo;

    public Graficos(int nroFichas, Hanoi nucleo) {
    ...
    private void configurarPanel() {
    	ImageIcon torresdemos = new ImageIcon("menu\\img\\torresdemos.png");
    	JLabel fondoD = new JLabel(torresdemos);
    ...
    private void inicializarComponentes() {
        ...
        for (int i = 1; i <= LIMITE_FICHAS; i++) {
            ImageIcon ii = new ImageIcon(this.getClass().getResource("/menu/img/" + i + ".png"));
    ...
    private void inicializarComponentesDeAnimacion() {
        ...
        topes[3] = 0;
        ficha = 1;
        movimientos = new Movimientos[(int) Math.pow(2, nroFichas)];
    ...
    public void paint(Graphics g) {
        ...
        g2.drawString("Torre 1", 100, 485);
        g2.drawString("Torre 2", 388, 485);
        g2.drawString("Torre 3", 676, 485);
    ...
    public void algoritmoHanoi(int n, int origen, int temporal, int destino) {
        ...
        nm++;
        movimientos[nm] = new Movimientos(n, origen, destino);
